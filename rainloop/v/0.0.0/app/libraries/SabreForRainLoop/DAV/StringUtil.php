 ...
 * Because they both need it, it was decided to put it in SabreForRainLoop\DAV instead.
 *
...
class StringUtil {
     ...
     * @return bool
     */
    public static function textMatch($haystack, $needle, string $collation, string $matchType = 'contains') : bool {
     ...
     * @return string
     */
    public static function ensureUTF8(string $input) : string {
