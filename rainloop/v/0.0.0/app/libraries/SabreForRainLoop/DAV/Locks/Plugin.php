...
namespace SabreForRainLoop\DAV\Locks;
 ...
 *
 * $lockBackend = new SabreForRainLoop\DAV\Locks\Backend\File('./mylockdb');
 * $lockPlugin = new SabreForRainLoop\DAV\Locks\Plugin($lockBackend);
